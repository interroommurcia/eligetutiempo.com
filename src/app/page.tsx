      ...
      <section className="bg-amber-600 text-white py-8 px-4">
        <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-4 text-center">
          <a href="https://instagram.com/eligetutiempo" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-2.5 bg-white/10 hover:bg-white/20 transition-colors px-5 py-3 rounded-xl font-semibold text-sm">
          ...
          <a href="https://whatsapp.com/channel/PENDIENTE" target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-2.5 bg-white/10 hover:bg-white/20 transition-colors px-5 py-3 rounded-xl font-semibold text-sm">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
