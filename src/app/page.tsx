    ...
    <>
      ...
      <section className="bg-black text-white py-24 px-4 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto text-center relative">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/catalogo"
              className="bg-[#C9A84C] hover:bg-[#E2C36A] text-black px-8 py-4 rounded-xl font-bold text-lg transition-all hover:scale-105 active:scale-95">
              Ver catálogo
            </Link>
            <Link href="/tasacion"
              className="border border-[#C9A84C]/40 hover:border-[#C9A84C] hover:bg-[#C9A84C]/10 text-white px-8 py-4 rounded-xl font-semibold text-lg transition-all hover:scale-105 active:scale-95">
              Valoración gratuita
            </Link>
          </div>
        </div>
      ...
      <section className="bg-[#0a0a0a] border-y border-[#C9A84C]/20 py-8 px-4">
        <div className="max-w-3xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-4 text-center">
          {[
            {
              href: "https://instagram.com/eligetutiempo",
              label: "@eligetutiempo",
            ...
            {
              href: "https://tiktok.com/@eligetutiempo",
              label: "@eligetutiempo",
            ...
            {
              href: "https://whatsapp.com/channel/0029Vb89q5LDOQIOA8PZb61f",
              label: "Tiempo con suerte",
            ...
            <a key={href} href={href} target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-2.5 border border-[#C9A84C]/30 hover:border-[#C9A84C] hover:text-[#C9A84C] text-stone-300 transition-all hover:scale-105 px-5 py-3 rounded-xl font-semibold text-sm">
              {icon}{label}
            </a>
          ))}
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <ScrollReveal>
            <div className="flex items-center justify-between mb-10">
              ...
              <Link href="/catalogo" className="text-[#C9A84C] hover:text-[#E2C36A] font-medium text-sm transition-colors">
                Ver todos →
              </Link>
            </div>
          </ScrollReveal>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {relojesDestacados.map((reloj, i) => (
              <ScrollReveal key={reloj.id} delay={((i % 3) * 200) as 0|100|200|300|400|500|600}>
      ...
      <ScrollReveal>
        <section className="py-20 px-4 bg-black border-t border-[#C9A84C]/20 text-white">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Link href="/tasacion"
              className="bg-[#C9A84C] hover:bg-[#E2C36A] text-black px-10 py-4 rounded-xl font-bold text-lg transition-all hover:scale-105 active:scale-95 inline-block">
      ...
      <section className="py-20 px-4 bg-[#0a0a0a]">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            {[
              { step: "01", title: "Envíanos tu reloj", desc: "Rellena el formulario con fotos y la referencia de tu reloj. Sin compromiso." },
              { step: "02", title: "Recibe tu valoración", desc: "En menos de 24h te enviamos una valoración real basada en el mercado actual." },
              { step: "03", title: "Vende o compra", desc: "Si aceptas la oferta, gestionamos todo. Pago seguro y envío asegurado." },
            ].map(({ step, title, desc }, i) => (
              <ScrollReveal key={step} delay={((i * 200) as 0|100|200|300|400|500|600)}>
                <div className="text-center group">
                  <div className="text-5xl font-black text-[#C9A84C]/25 mb-4 group-hover:text-[#C9A84C]/50 transition-colors">{step}</div>
